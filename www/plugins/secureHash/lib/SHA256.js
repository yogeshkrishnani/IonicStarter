 ...
 */
;
var secureHashLibInit = function(root, undefined) {
	'use strict';
	...
	var sha256 = function(message, is224) {
		...
		var h0, h1, h2, h3, h4, h5, h6, h7, block, code, first = true, end = false, i, j, index = 0, start = 0, bytes = 0, length = message.length, s0, s1, maj, t1, t2, ch, ab, da, cd, bc;
		...
		if (!is224) {
			hex += HEX_CHARS[(h7 >> 28) & 0x0F] + HEX_CHARS[(h7 >> 24) & 0x0F]
					...
					+ HEX_CHARS[(h7 >> 8) & 0x0F] + HEX_CHARS[(h7 >> 4) & 0x0F]
					+ HEX_CHARS[h7 & 0x0F];
		}
		return hex;
	};
