...
function NativePageTransitionPlugin() {
}

NativePageTransitionPlugin.prototype.globalOptions = {
	duration : 400,
	...
	fixedPixelsBottom : 0
// currently for slide left/right only
};

NativePageTransitionPlugin.prototype.executePendingTransition = function(onSuccess, onError) {
	cordova.exec(onSuccess, onError, "NativePageTransitions", "executePendingTransition", []);
};

NativePageTransitionPlugin.prototype.slide = function(options, onSuccess, onError) {
	var opts = options || {};
	...
	opts.slowdownfactor = opts.slowdownfactor
			|| this.globalOptions.slowdownfactor;
	cordova.exec(onSuccess, onError, "NativePageTransitions", "slide", [ opts ]);
};

NativePageTransitionPlugin.prototype.drawer = function(options, onSuccess, onError) {
	var opts = options || {};
	if (!this._validateHref(opts.href, onError)) {
		return;
	}
...
NativePageTransitionPlugin.prototype.flip = function(options, onSuccess, onError) {
	var opts = options || {};
	if (!this._validateHref(opts.href, onError)) {
		return;
	}
...
NativePageTransitionPlugin.prototype.curl = function(options, onSuccess, onError) {
	var opts = options || {};
	if (!this._validateHref(opts.href, onError)) {
		return;
	}
...
NativePageTransitionPlugin.prototype.fade = function(options, onSuccess, onError) {
	var opts = options || {};
	if (!this._validateHref(opts.href, onError)) {
		return;
	}
...
NativePageTransitionPlugin.prototype._validateHref = function(href, errCallback) {
...
NativePageTransitionPlugin.install = function() {
	if (!window.plugins) {
		window.plugins = {};
	}

	window.plugins.NativePageTransitionPlugin = new NativePageTransitionPlugin();
	return window.plugins.NativePageTransitionPlugin;
};

NativePageTransitionPlugin.install();